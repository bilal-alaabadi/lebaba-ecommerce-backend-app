...
router.post("/create-checkout-session", async (req, res) => {
    ...
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            mode: "payment",
            success_url: "https://lebaba-ecommerce-backend-app-snowy.vercel.app/success?session_id={CHECKOUT_SESSION_ID}",
            cancel_url: "https://lebaba-ecommerce-backend-app-snowy.vercel.app/cancel",
            metadata: {
                province,
                wilayat,
                streetAddress,
